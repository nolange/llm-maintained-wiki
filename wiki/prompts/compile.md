...
Read `wiki/_index.md` to understand what articles already exist.

### 2. Process each source file

For each source file:
- Read the file
- Check `_index.md`: does this warrant a **new article** or should content be **merged into an existing one**?
...
After writing articles, update `_index.md`:
- Add a line for each new article: `- [Title](filename.md) — tags: [tag1, tag2]`
- Update the tag list for any article you modified.
